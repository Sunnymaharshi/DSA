...
using namespace std;
/*
    we can do this problem in direct way by asigning + and - for every element.
    It is same as difference of any 2 subsets.
    one subset contains any no of elements.
    totalSum - 1st subset sum is sum of elements in 2nd subset.
*/
...
int32_t main() {
    ...
    for(int i=0;i<n;i++)
        cin>>arr[i];
    cout<<countPartitionsWithDiff(n,target,arr);
    return 0;
}
/*
Output:
